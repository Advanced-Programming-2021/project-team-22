...
//        if cardName isn't available, then this method returns false
    ...
    public boolean addMonsterCardToMonsterZone(MonsterCard monsterCard) {
        for (int i = 1; i < monstersZone.length; i++) {
    ...
    public void drawCard() {
        Card card = deck.mainCards.get(deck.mainCards.size() - 1);
        cardsInHand.add(card);
        deck.mainCards.remove(deck.mainCards.size() - 1);
