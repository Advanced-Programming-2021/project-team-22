...
public enum DuelMenuMessages {
    ...
    CARD_SELECTED("showSelectedCard selected\n"),
    CARD_NOT_FOUND("no showSelectedCard found in the given position\n"),
    UNAVAILABLE_SELECTED_CARD("no showSelectedCard is selected yet\n"),
    ...
    CARD_ACTIVATED_BEFORE("you have already activated this showSelectedCard\n"),
    FULL_MAGICS_ZONE("spell showSelectedCard zone is full\n"),
    UNDONE_PREPARATIONS("preparations of this spell are not done yet\n"),
    SET_IN_THIS_TURN("you set this showSelectedCard in this turn so you can't activate it\n"),
    SPELL_ACTIVATED("spell activated\n"),
    TRAP_ACTIVATED("trap activated\n"),
    NOT_OWNER("you aren't owner of selected showSelectedCard\n"),
    CANT_SET("you can’t set this showSelectedCard\n"),
    NOT_TRUE_PHASE("you can’t do this action in this phase\n"),
    SET_SUCCESSFULLY("set successfully\n"),
    NOT_SELECTED_CARD("no showSelectedCard is selected yet\n"),
    ATTACKED_BEFORE("this showSelectedCard already attacked\n"),
    NO_CARD_FOUND_IN_THE_POSITION("no showSelectedCard found in the given position\n"),
    CANT_ATTACK_WITH_CARD("you can’t attack with this showSelectedCard\n"),
    YOU_CANT_ATTACK_TO_THIS_CARD("you cant attack to this showSelectedCard\n"),
    ATTACK_CANCELED("attack to this showSelectedCard was canceled\n"),
    DIRECT_ATTACK_DONE("you opponent receives <damage> battle damage\n"),
    DH_EQUAL_DAMAGE("opponent’s monster showSelectedCard was <monster showSelectedCard name> and no showSelectedCard is destroyed\n"),
    DESELECTED("showSelectedCard deselected\n"),
    OPPONENT_GOT_DAMAGE_IN_ATTACK("your opponent’s monster is destroyed and your opponent receives <damage> battle damage\n"),
    ATTACKING_PLAYER_CARD_DESTROYED("Your monster showSelectedCard is destroyed and you received <damage> battle damage\n"),
    DEFENSE_POSITION_MONSTER_DESTROYED("the defense position monster is destroyed\n"),
    NO_CARD_DESTROYED("no showSelectedCard is destroyed\n"),
    RECEIVE_DAMAGE_BY_ATTACKING_TO_DEFENSE_CARD("no showSelectedCard is destroyed and you received <damage> battle damage\n"),
    ...
    UNAVAILABLE_CARD_CHEAT_CODE("your entered showSelectedCard name is unavailable\n"),
    INVALID_COMMAND_CHEAT_CODE("invalid command\n"),
    ACTION_CANCELED_BY_TRAP_CARD("action canceled by a trap showSelectedCard\n"),
    INVISIBLE_CARD("showSelectedCard is not visible\n"),
    SUMMONED_SUCCESSFULLY("summoned successfully\n"),
    SUMMON_NOT_POSSIBLE("action not allowed in this phase\n"),
    FULL_MONSTERS_ZONE("monster showSelectedCard zone is full\n"),
    ...
    public static void setAttackingPlayerCardDestroyed(int damage) {
        DuelMenuMessages.ATTACKING_PLAYER_CARD_DESTROYED.message =
                "Your monster showSelectedCard is destroyed and you received " + damage + " battle damage\n";
    }
    ...
    public static void setReceiveDamageByAttackingToDefenseCard(int damage) {
        DuelMenuMessages.RECEIVE_DAMAGE_BY_ATTACKING_TO_DEFENSE_CARD.message =
                "no showSelectedCard is destroyed and you received " + damage + " battle damage\n";
    }

    public static void setDHEqualDamage(String cardName) {
        DuelMenuMessages.DH_EQUAL_DAMAGE.message = "opponent’s monster showSelectedCard was " + cardName + " and no showSelectedCard is destroyed\n";
    }
