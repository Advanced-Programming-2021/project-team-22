...
public class DuelMenuController {
    ...
    public static void preparePlayerForNextGame(Player player) {
        ...
        if (player.getUsername().equals("")) Player.removePlayer(player);
    }
...
//        this is never happen
    ...
    public DuelMenuMessages initialGame(Player firstPlayer, Player secondPlayer) {
        ...
        System.out.println(notTurnPlayer.getUsername() + "ASDASD");
        System.out.println(turnPlayer.getUsername() + "QWEQWEQWE");
        ...
        DuelMenuView.setDuelMenuController(this);
    ...
    private DuelMenuMessages attack(String command) {
        ...
        if (matcher.find()) {
            ...
            if (result == null) {
                ...
                System.out.println(tempResult.getMessage());
